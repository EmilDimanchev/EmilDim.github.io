...
1. Where do we want to go: Assessing the performance of alternative net-zero energy system design options and generating future scenarios for actionable planning guidance, particularly under uncertainty. Example works: [here](https://doi.org/10.1016/j.enpol.2021.112369), [here](https://www.sciencedirect.com/science/article/pii/S2211467X25000276), [here](https://iopscience.iop.org/article/10.1088/2634-4505/ad763e).
...
3. How do we know: Advancing state-of-the-art optimization-based methods for modeling energy systems with a particular focus on high-resolution policy modeling under political economy constraints. Example works: [here](https://doi.org/10.1016/j.eneco.2024.107639), [here](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5636369).
